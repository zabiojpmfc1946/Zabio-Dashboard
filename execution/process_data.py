...
def process_data():
    ...
    # New: Monthly volume per client (Top 5 for chart readability)
    ...
    # 3. Time Series Data (Daily Total & Per Client)
    ...
    print(f"Metrics Processed with Time Series and Avg Tx size.")
